      ...
      <Section title={"Quem eu sou?"}>
        <div ref={whoAmISectionRef}>
          ...
          <p>
            ...
            <Emoji symbol="🇵🇹" /></p>
          <br />
          <p>Antes de tudo, um artista, gosto de criar coisas incríveis! 
          </p>
          <br/>
          <p>Tenho Bacharelado em Sistemas de Informação pela Universidade Federal do Piauí (UFPI) com especialização em Desenvolvimento de Games pelo SENAC.
Em meu tempo livre amo programar, jogar vídeo game, consumir entretenimento geek/nerd, tocar violão e piano e andar de skate.</p>
          <br />
